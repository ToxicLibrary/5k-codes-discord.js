...
if(message.channel.id === db.get(`ticket${message.author.id}`,"ticketid")) {
require("fs").appendFile(`./tickets/transcript-${message.channel.name}.html`,`
<!DOCTYPE html>
<html>
<head>
...
<body>
<div class="container">
<h8>${message.author.username}: </h8>
<img src="${message.author.avatarURL}" alt="Avatar" style="width:100%;">
<p>${message.content}</p>
<span class="time-right">${require("moment")(new Date()).format('h:mm A')}</span>
</div>`, function(err) {
...
client.login("Njg2NDkyMTExNTk5NTY2ODkx.XmX_yQ.bJs4_jgCAV0I2AXwYGgkzabBlVo");
